...
В меню на кнопке «Свернуть» два подменю: «🎨 Тема ▸» и «🔤 Шрифт ▸». В каждом сверху список для ЭТОГО окна, а
«Всем окнам ▸» — вложенным подменю внутри (с заголовком «ВСЕМ ОКНАМ»): раньше «Тема окна» и «Тема всех окон» стояли
двумя пунктами вплотную и подменялись при скольжении мыши вниз — отсюда «покрасило все окна» (#5313).

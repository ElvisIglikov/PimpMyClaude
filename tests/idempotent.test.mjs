...
// Пять узлов, которые инжект держит в окне. Ручка ставится разделом 9, полоса
// прогресса, её коробка-подсказка и карточка сегмента (WF22) — разделом 2б,
// рамка окна — разделом 2а; узлы живут независимо от того, включён ли слой,
// поэтому счёт «ровно один» верен всегда.
const NODE_IDS = [

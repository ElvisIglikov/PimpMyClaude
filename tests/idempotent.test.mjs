...
// Шесть узлов, которые инжект держит в окне. Ручка ставится разделом 9, полоса
// прогресса, её коробка-подсказка и карточка сегмента (WF22) — разделом 2б,
// рамка окна — разделом 2а, рейка ширины правой колонки (WF65) — разделом 2г;
// узлы живут независимо от того, включён ли слой, поэтому счёт «ровно один»
// верен всегда.
const NODE_IDS = [
